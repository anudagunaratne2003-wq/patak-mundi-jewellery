...
export function CheckoutPage() {
    ...
    return (
      <div className="container-lux py-24 text-center animate-fade-in">
        ...
        <p className="mt-3 max-w-md mx-auto text-sm text-charcoal-500">
          ...
          number is <span className="font-medium text-charcoal-800">#{orderNumber}</span>.
        </p>
        <button
          type="button"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      pushToast('Something went wrong placing your order. Please try again.', 'error');
    } finally {
      setPlacing(false);
    }
  };
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-28 bg-ivory-100 p-7">
            ...
            <button
              type="submit"
              disabled={placing}
              className="group mt-6 flex w-full items-center justify-center gap-2 bg-charcoal-900 py-4 text-xs font-medium uppercase tracking-widest text-ivory-50 transition-colors hover:bg-champagne-500 disabled:opacity-60"
            >
